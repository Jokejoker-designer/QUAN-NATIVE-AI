...
1. `README.md`
2. `AGENTS.md`
3. `docs/NATIVE_AI_ARTY_A7_BLUEPRINT/00_CURRENT_AUTHORITY.md`
4. `docs/NATIVE_AI_ARTY_A7_BLUEPRINT/04_HARDSTOPS.md`
5. `docs/authority-root/ASTRA_NATIVE_AI_MASTER_V1_1_POST_SILICON_FINAL.md`
6. `results/A7-NATIVE-GRAPH/STATUS/HARD_BLOCK_MASTER_C3_C6.md`
7. `results/A7-NATIVE-GRAPH/STATUS/LOOP_STATE.json`
8. `handoff/ASTRA_HANDOFF/C1_C6_CLOSE_PLAN_20260909/MASTER_CLOSURE_PLAN.md`
9. `handoff/ASTRA_HANDOFF/C1_C6_CLOSE_PLAN_20260909/CURSOR_WORK_ORDERS.md`
10. `handoff/ASTRA_HANDOFF/C1_C6_CLOSE_PLAN_20260909/TECHNICAL_PLAYBOOKS.md`
