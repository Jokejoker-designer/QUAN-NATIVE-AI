// tb_astra_c1_semantic_800k.sv — C1 SEMANTIC-800K. PROGRAM=NO.
...
// AND FILL_TEMPLATE_HIT AND HIGH_ID_HIT nid=799999.
// Do not drop N from 800000. Headline precision_all=TP/emit_n.
`timescale 1ns / 1ps

module tb_astra_c1_semantic_800k;
  import a7ng_pkg::*;
  ...
  initial begin
    ...
    $display("N800K_SUMMARY fill_tp=%0d nl_hit=%0d high_hit=%0d emit_has_131=%0d incomp_retrieve=%0d fail=%0d G_N=%0d",
