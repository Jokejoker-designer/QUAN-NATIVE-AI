#!/usr/bin/env python3
"""ASTRA-C1-SEMANTIC-800K-01 independent host gold.
...
GATE = "ASTRA-C1-SEMANTIC-800K-01"
...
def main() -> int:
    ...
    chk(N_REL >= 8, f"rel<{8}")
    chk(N_ENT >= 200, "800k unique cartesian needs >=200 subjects")
    ...
    if fails:
        print("ASTRA_C1_SEMANTIC_800K_HOST_FAIL")
        for f in fails:
            print("FAIL", f)
        return 2
    ...
    corpus = {
        "gate": GATE,
        "n": N,
        "generator": "cartesian_new_subj_800k_v1",
        "procedural": True,
        "not_16k_clone": True,
        "n_subjects": N_ENT,
        "n_rels": N_REL,
    ...
    print("ASTRA_C1_SEMANTIC_800K_HOST_OK")
