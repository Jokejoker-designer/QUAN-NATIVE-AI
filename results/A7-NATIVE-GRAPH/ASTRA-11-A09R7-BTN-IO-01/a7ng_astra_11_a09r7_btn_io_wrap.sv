// a7ng_astra_11_a09r7_btn_io_wrap.sv — ASTRA-11-A09R7-BTN-IO-01.
// PROGRAM=NO. BIT=NO. Named BTN-IO wrap: R7 query-rew FSM + UART IOB FFs + LED IOB FFs + BTN IOB FFs.
// Instantiates frozen a7ng_astra_09_r2_cand_ovf (no copy-paste graph).
// Prior a7ng_astra_11_a09r7_led_io_wrap KEEP, not this top. Not PRODUCTION_TOP.
...
`timescale 1ns / 1ps
`include "a7ng_astra_11_a09r7_btn_io.svh"
...
module a7ng_astra_11_a09r7_btn_io_wrap (
  ...
  // BTN IOB pad FFs (PREREG). INIT 0. No SR so Vivado can pack into IOB.
  ...
  (* keep_hierarchy = "yes" *)
  a7ng_astra_11_a09r7_btn_io_plant u_plant (
  ...
  // Use btn_q (IOB-sampled), never raw btn, so BTN input delay is pad→IOB FF.
