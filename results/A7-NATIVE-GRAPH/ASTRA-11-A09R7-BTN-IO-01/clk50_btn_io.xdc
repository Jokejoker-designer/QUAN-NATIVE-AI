...
# BTN0-BTN3 = D9/C9/B9/B8 (this bag's residual).
...
# BTN input delays FROZEN in PREREG: IN max 2.000 min 0.500 vs clk50u.
...
# Do NOT set_false_path on btn[*] (LED bag residual). sw[*] remains false-pathed.
