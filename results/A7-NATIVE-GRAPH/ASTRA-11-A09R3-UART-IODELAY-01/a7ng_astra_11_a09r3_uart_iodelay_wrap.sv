// a7ng_astra_11_a09r3_uart_iodelay_wrap.sv — ASTRA-11-A09R3-UART-IODELAY-01.
// PROGRAM=NO. BIT=NO. Named UART wrap with frozen I/O delays (PREREG).
...
module a7ng_astra_11_a09r3_uart_iodelay_wrap (
