// tb_astra_c1_key_intersect.sv — C1 N=256 qse-v2-intersect-01. PROGRAM=NO.
...
module tb_astra_c1_key_intersect;
  import a7ng_pkg::*;
  ...
  initial begin
    ...
    $display("C1_KEY_INTERSECT_N=%0d CAND_CAP=%0d INDEX_HEAD=%0d LAW=qse-v2-intersect-01 POKE_V=0 REDUCTION_X1000=NOT_EMITTED",
    ...
    if (fail == 0 && dist_gold_ok && dist_excl_ok && dist_no_leak && unrelated_empty && wc_not_sel && (direct_tp > 0)) begin
      $display("ASTRA_C1_KEY_INTERSECT_XSIM_PASS");
      ...
      $display("ASTRA_C1_KEY_INTERSECT_XSIM_NO_MARKER fail=%0d dist_gold_ok=%0d dist_excl_ok=%0d dist_no_leak=%0d unrelated_empty=%0d wc_not_sel=%0d direct_tp=%0d",
