# OOC synth/impl for a7ng_wm00_top — wm00_timing archive (systolic Top-8 pipeline)
# Writes under results/A7-NATIVE-GRAPH/BRAM-WM-00/timing/ — does not wipe control OOC.
set root [file normalize [file join [file dirname [info script]] ../../../..]]
set outdir [file join $root results/A7-NATIVE-GRAPH/BRAM-WM-00/timing]
file mkdir $outdir
set part xc7a100tcsg324-1

create_project -force wm00_timing_ooc [file join $outdir vivado_wm00_timing_ooc] -part $part
...
set xdc [file join $outdir wm00_timing_ooc.xdc]
set fh [open $xdc w]
...
puts "WM00_TIMING_OOC_UTIL=[file join $outdir util_route.rpt]"
puts "WM00_TIMING_OOC_TIMING=[file join $outdir timing_route.rpt]"
puts "A7NG_BRAM_WM00_TIMING_OOC_DONE"
