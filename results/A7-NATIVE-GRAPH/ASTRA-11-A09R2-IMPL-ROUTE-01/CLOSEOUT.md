# CLOSEOUT — ASTRA-11-A09R2-IMPL-ROUTE-01

```text
RESULT               = PASS_THIS_GATE_ONLY
TASK                 = ASTRA-11-A09R2-IMPL-ROUTE-01
SESSION              = UNKNOWN
...
WNS                  = 0.648 ns  (timing_route.rpt Design Timing Summary; Design State=Routed; clk50u)
TNS                  = 0.000 ns
WHS                  = 0.126 ns
THS                  = 0.000 ns
ROUTE_LUT            = 1321   (util_route.rpt Slice LUTs; Design State=Routed)
ROUTE_FF             = 1103
BRAM_TILE            = 0
DSP                  = 2      (DSP48E1 in u_sgd; on routed worst path)
SYNTH_LUT            = 5251   (util_synth.rpt; not the WNS quote)
BIT                  = NOT_BUILT
PROGRAM              = NO
