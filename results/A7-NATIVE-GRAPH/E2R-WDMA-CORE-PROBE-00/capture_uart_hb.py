#!/usr/bin/env python3
"""Capture COM12 for E2R-WDMA-CORE-PROBE-00 — F1m WDMA/CORE probe."""
...
def main():
    ...
    while time.time() - t0 < args.seconds:
        ...
        if "LM" in text_so_far.splitlines() and (time.time() - t0) > 90.0:
            if any(x in text_so_far for x in (
                    "WDMA_BUSY", "WDMA_DONE", "CORE_BUSY", "BIND_BUSY",
                    "PRED_NZ", "CORE_DONE")) or \
