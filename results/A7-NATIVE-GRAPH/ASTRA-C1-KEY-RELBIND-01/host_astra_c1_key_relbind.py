#!/usr/bin/env python3
"""ASTRA-C1-KEY-RELBIND-01 independent host gold for qse-v2-relbind-01.

Frozen extract (qse-v2-role-00) is instantiated unchanged. Host twin rebinds
k2={rel_id, subj_cue[7:0]} k3={rel_id, obj_cue[7:0]}; k0/k1 pass through.
Index/postings rebuilt with the SAME function. N=256.
...
def write_svh(path: Path, queries: list[dict], writes: dict[int, int], docs: list[dict]) -> None:
    ...
    lines = [
        "// generated by host_astra_c1_key_relbind.py — independent gold BEFORE xvlog. do not hand-edit after FAIL",
        "// Law qse-v2-relbind-01: k2={rel,subj_cue[7:0]} k3={rel,obj_cue[7:0]}; k0/k1 frozen pass-through",
...
def main() -> int:
    ...
    if fails:
        print("ASTRA_C1_KEY_RELBIND_HOST_FAIL")
        for f in fails:
            print("FAIL", f)
        return 2
    ...
    golden = {
        ...
        "key_rebind": "k2={rel_id,subj_cue[7:0]} k3={rel_id,obj_cue[7:0]} k0k1_passthrough",
        "n": N,
        "cand_cap": CAND_CAP,
        "index_head": INDEX_HEAD,
        "n_host": 0,
        ...
        "wrong_context_policy": "NOT_SELECTIVE qse-v2-relbind-01 xid not directory key; do not fake ctx keys",
    ...
    print("ASTRA_C1_KEY_RELBIND_HOST_PASS")
