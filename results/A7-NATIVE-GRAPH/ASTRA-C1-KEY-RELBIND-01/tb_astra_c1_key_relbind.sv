// tb_astra_c1_key_relbind.sv — C1 N=256 qse-v2-relbind-01. PROGRAM=NO.
// Frozen QSE + named key rebind + frozen sparse dir. poke_v=0. leftover A09 off.
...
module tb_astra_c1_key_relbind;
  import a7ng_pkg::*;
  ...
  initial begin
    ...
    $display("C1_KEY_RELBIND_N=%0d CAND_CAP=%0d INDEX_HEAD=%0d LAW=qse-v2-relbind-01 POKE_V=0 REDUCTION_X1000=NOT_EMITTED",
    ...
    for (qi = 0; qi < G_NQ; qi = qi + 1) begin
      ...
      if (qi == 4) begin
        ...
        $display("NOT_SELECTIVE class=wrong_context k0=%0d k1=%0d k2=%0d k3=%0d vs_direct k0=%0d k1=%0d k2=%0d k3=%0d keys_match=%0d emit_match=%0d law=qse-v2-relbind-01 xid_not_directory_key rec_is_not_context_selectivity=1",
    ...
    if (fail == 0 && dist_gold_ok && dist_excl_ok && dist_no_leak && unrelated_empty && wc_not_sel && (direct_tp > 0)) begin
      $display("ASTRA_C1_KEY_RELBIND_XSIM_PASS");
      ...
      $display("ASTRA_C1_KEY_RELBIND_XSIM_NO_MARKER fail=%0d dist_gold_ok=%0d dist_excl_ok=%0d dist_no_leak=%0d unrelated_empty=%0d wc_not_sel=%0d direct_tp=%0d",
