...
// Test-only identities for ASTRA-C5-HELDOUT-TRANSFER-MIG-01 plant (TB hierarchy).
// Copied from C5 held-out transfer. Not a production qid→answer map.
// PROGRAM=NO. Do not edit after xvlog.
