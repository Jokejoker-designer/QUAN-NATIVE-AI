// tb_astra_c1_n262144_scale.sv — C1 N262144 SCALE. PROGRAM=NO.
...
module tb_astra_c1_n262144_scale;
  import a7ng_pkg::*;
  ...
  initial begin
    ...
    if (G_N != 262144)
      diverge("N_DROP", "G_N!=262144 do_not_silently_drop_N");
    if (G_PROC_MEM != 1)
    ...
    if (G_SEN_NID != 20'd262143)
      diverge("SENTINEL", "G_SEN_NID!=262143");
    if (G_LATE_NID != 20'd262142)
      diverge("LATE_NID", "G_LATE_NID!=262142");
    ...
    $display("C1_N262144_SCALE_N=%0d N_BUCKETS=%0d CAND_CAP=%0d INDEX_HEAD=%0d LAW=qse-v2-relctx-synonym-01 CTX=qse-v2-intersect-context-02 LEX=qse-v2-lex-semantic-800k-01 POKE_V=0 PAGE_BUFFER_BEATS=1 RARE_LIST_FIRST=1 CAND_CAP_AFTER_EMIT=1 CAND_CAP_FINAL=NOT_FROZEN DDR_QUERY_BOUND_FINAL=NOT_FROZEN PROC_MEM=1 N_ADDRESSABLE=262144 N_SUBJECTS=%0d N_RELS=%0d FILL_GRID=120,121,122 FILL_K0=%0d FILL_K1=%0d SEN_NID=262143 LATE_NID=262142",
    ...
    $display("N262144_SUMMARY fill_tp=%0d nl_hit=%0d late_hit=%0d high_hit=%0d emit_has_131=%0d incomp_retrieve=%0d fail=%0d G_N=%0d",
      fill_tp, nl_hit, late_hit, high_hit, emit_has_131, incomp_retrieve, fail, G_N);
    if ((fail == 0) && unrelated_empty && (fill_tp > 0) && fill_ids_ok && (keys_match == 0) && keys_match_syn && nl_hit && (nl_tp >= 3) && (emit_has_131 == 0) && late_hit && high_hit && (incomp_retrieve == 0) && (G_N == 262144)) begin
      $display("ASTRA_C1_N262144_SCALE_XSIM_PASS");
      ...
      $display("ASTRA_C1_N262144_SCALE_XSIM_NO_MARKER fail=%0d unrelated_empty=%0d fill_tp=%0d fill_ids_ok=%0d keys_match_frozen=%0d keys_match_syn=%0d nl_hit=%0d late_hit=%0d high_hit=%0d incomp_retrieve=%0d G_N=%0d",
