// a7ng_astra_11_a09r8_uart_freeze_plant.sv — ASTRA-11-A09R8-UART-FREEZE-BIT-01.
// PROGRAM=NO. Bag-local behavioral AXI plant. Not silicon BRAM. Not a7ng_axi_bram128 edit.
// Not an edit of ASTRA-11-A09R7 plant source. Same smoke/ovf maps as B plant.
`timescale 1ns / 1ps

module a7ng_astra_11_a09r8_uart_freeze_plant (
  input  logic        clk,
  input  logic        rst_n,
