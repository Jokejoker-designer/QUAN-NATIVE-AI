#!/usr/bin/env python3
"""ASTRA-C1-N256-R2 independent host gold for frozen qse-v2-role-00 + sparse dir.
...
def write_svh(path: Path, queries: list[dict], writes: dict[int, int], docs: list[dict]) -> None:
    ...
    lines = [
        "// generated by host_astra_c1_r2.py — independent gold BEFORE xvlog. do not hand-edit after FAIL",
...
def main() -> int:
    ...
    chk(psc_nids.isdisjoint(set(gold_map["distractor"])), "distractor gold is PSC")
