...
module tb_astra_c1_n256_r2;
  ...
  integer unrelated_empty, wc_not_sel, dist_gold_ok, keys_match, emit_match;
  integer direct_n;
  ...
  initial begin
    ...
    $display("C1_R2_N=%0d CAND_CAP=%0d INDEX_HEAD=%0d LAW_SEL=1 POKE_V=0 REDUCTION_X1000=NOT_EMITTED",
    ...
    if (fail == 0 && dist_gold_ok && unrelated_empty && wc_not_sel) begin
      $display("ASTRA_C1_N256_R2_XSIM_PASS");
      ...
      $display("ASTRA_C1_N256_R2_XSIM_NO_MARKER fail=%0d dist_gold_ok=%0d unrelated_empty=%0d wc_not_sel=%0d",
        fail, dist_gold_ok, unrelated_empty, wc_not_sel);
    end
    #20 $finish;
  end
endmodule
