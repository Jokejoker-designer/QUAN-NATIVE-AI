...
# LED I/O delays FROZEN in PREREG before impl. Copied 2.000/0.500 from repo
# 3.3 V CMOS I/O class (not invented after WNS). Applied AFTER synth when
# MMCM-derived clk50u exists. LEDs are related on-board outputs of clk50u.
# Do not time against uart_io_vclk. Do not false-path-hold led[*].
