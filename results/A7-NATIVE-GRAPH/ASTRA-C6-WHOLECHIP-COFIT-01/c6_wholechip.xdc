# ASTRA-C6-WHOLECHIP-COFIT-01. PROGRAM=NO.
# Official Arty A7-100T CLK/UART/LED/BTN come from constraints/arty_a7_100.xdc
# (do not edit that file). Official DDR3 pads come from unmodified
# vivado/ip/mig_7series_0/.../mig_7series_0.xdc (do not edit).
# A09R8 is not this top. UART IOB FF forbidden (A09R3 hold RCA).
# uart_io_vclk is an async FTDI reference; C5 uart_rx 2-FF is the CDC.
