...
CAND_CAP             = 16
MAX_PATH             = 4
OVF_PLANT_N          = 64 (> CAND_CAP; not 65536)
OVERFLOW             = DUT INCOMP ans=0 p0=0 ntrunc=48 r_ovf=1 w_ovf=0; hier_ans=0 hier_best=0
SMOKE                = two-proof ans=4 p0=17 after hard reset
UNREL                = UNKNOWN npath=0 ans=0 p0=0
ISO                  = +3 x0=50 dw0=+5 (no force)
LOAD_FROM_TB         = 0
ASTRA-07-NARROW / ASTRA-09-R2 / ASTRA-12-R5 / ASTRA-12* / ASTRA-11* / F2R* / F3* / ASTRA-06-* = preserved, not edited; run scripts not rerun
BIT                  = NOT_BUILT
PROGRAM              = NO
...
Independent auditor of this scale-mid bag. Do not open LM06, BOARD, DDR,
Master F3, Master ASTRA-07 65536/800k, or ASTRA-13 from this bag. Do not freeze
PRODUCTION_TOP. Do not patch frozen A09-R2 or leftover A09. PROGRAM=NO.
