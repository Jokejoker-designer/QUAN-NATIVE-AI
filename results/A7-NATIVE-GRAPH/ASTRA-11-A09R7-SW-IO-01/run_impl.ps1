...
if ($liveA09 -ne $expectA09) { throw "A11A09R7_SW_IO_FROZEN_A09_HASH_CHANGED $liveA09" }
if ($liveR2  -ne $expectR2)  { throw "A11A09R7_SW_IO_DUT_HASH_CHANGED $liveR2" }
if ($liveSgd -ne $expectSgd) { throw "A11A09R7_SW_IO_SGD_HASH_CHANGED $liveSgd" }
if ($liveRx  -ne $expectRx)  { throw "A11A09R7_SW_IO_UART_RX_HASH_CHANGED $liveRx" }
if ($liveTx  -ne $expectTx)  { throw "A11A09R7_SW_IO_UART_TX_HASH_CHANGED $liveTx" }
$compiled = @(
  ...
  $uartRx,
  $uartTx,
  (Join-Path $bag "a7ng_astra_11_a09r7_sw_io_plant.sv"),
  (Join-Path $bag "a7ng_astra_11_a09r7_sw_io_wrap.sv"),
  (Join-Path $bag "clk50_sw_io.xdc"),
  (Join-Path $bag "led_iodelay.xdc"),
  (Join-Path $bag "sw_iodelay.xdc"),
...
$includes = @(
  ...
  (Join-Path $bag "a7ng_astra_11_a09r7_sw_io.svh")
)
function Rel([string]$p) {
  return $p.Substring($root.Length).TrimStart('\', '/').Replace('\', '/')
}
function ShaLine([string]$p) {
  if (-not (Test-Path -LiteralPath $p)) { throw "A11A09R7_FILE_MISSING $p" }
  $h = (Get-FileHash -Algorithm SHA256 -LiteralPath $p).Hash.ToLowerInvariant()
  return "$h  $(Rel $p)"
}
foreach ($f in $compiled) {
  $bn = [IO.Path]::GetFileName($f)
  if ($bn -eq "a7ng_astra09_pipe.sv" -or $bn -eq "a7ng_astra_09_integ_path.sv" -or $bn -eq "arty_a7_astra09_soc_top.sv" -or $bn -eq "arty_a7_astra_rtp_soc_top.sv" -or $bn -eq "a7ng_astra_09_r3_uart_wrap.sv" -or $bn -eq "a7ng_astra_09_r7_uart_query_rew_wrap.sv" -or $bn -eq "a7ng_astra_09_r7_axi_plant.sv" -or $bn -eq "a7ng_astra_11_a09r3_uart_impl_wrap.sv" -or $bn -eq "a7ng_astra_11_a09r3_uart_iodelay_wrap.sv" -or $bn -eq "a7ng_astra_11_a09r3_uart_iobff_wrap.sv" -or $bn -eq "a7ng_astra_11_a09r3_uart_iobff_hold_wrap.sv" -or $bn -eq "a7ng_astra_11_a09r3_uart_iobff_plant.sv" -or $bn -eq "a7ng_astra_11_a09r3_uart_iobff_hold_plant.sv" -or $bn -eq "a7ng_astra_11_a09r7_uart_impl_wrap.sv" -or $bn -eq "a7ng_astra_11_a09r7_uart_impl_plant.sv" -or $bn -eq "a7ng_astra_11_a09r7_led_io_wrap.sv" -or $bn -eq "a7ng_astra_11_a09r7_led_io_plant.sv" -or $bn -eq "a7ng_astra_11_a09r7_btn_io_wrap.sv" -or $bn -eq "a7ng_astra_11_a09r7_btn_io_plant.sv" -or $bn -eq "a7ng_astra_11_a09r7_btn_idelay_wrap.sv" -or $bn -eq "a7ng_astra_11_a09r7_btn_idelay_plant.sv" -or $bn -match "pipe_r1|plant128|axi_bram128") {
...
$lines += (ShaLine (Join-Path $root "results\A7-NATIVE-GRAPH\ASTRA-11-A09R7-UART-IMPL-ROUTE-01\a7ng_astra_11_a09r7_uart_impl_wrap.sv"))
$lines += (ShaLine (Join-Path $root "results\A7-NATIVE-GRAPH\ASTRA-11-A09R7-UART-IMPL-ROUTE-01\clk50_uart_impl.xdc"))
$lines += (ShaLine (Join-Path $root "results\A7-NATIVE-GRAPH\ASTRA-11-A09R7-LED-IO-01\a7ng_astra_11_a09r7_led_io_wrap.sv"))
$lines += (ShaLine (Join-Path $root "results\A7-NATIVE-GRAPH\ASTRA-11-A09R7-LED-IO-01\clk50_led_io.xdc"))
$lines += (ShaLine (Join-Path $root "results\A7-NATIVE-GRAPH\ASTRA-11-A09R7-BTN-IO-01\a7ng_astra_11_a09r7_btn_io_wrap.sv"))
$lines += (ShaLine (Join-Path $root "results\A7-NATIVE-GRAPH\ASTRA-11-A09R7-BTN-IO-01\clk50_btn_io.xdc"))
$lines += (ShaLine (Join-Path $root "results\A7-NATIVE-GRAPH\ASTRA-11-A09R7-BTN-IDELAY-01\a7ng_astra_11_a09r7_btn_idelay_wrap.sv"))
$lines += (ShaLine (Join-Path $root "results\A7-NATIVE-GRAPH\ASTRA-11-A09R7-BTN-IDELAY-01\clk50_btn_idelay.xdc"))
$lines += (ShaLine (Join-Path $root "constraints\arty_a7_100.xdc"))
...
$lines += (ShaLine (Join-Path $root "results\A7-NATIVE-GRAPH\ASTRA-11-A09R3-UART-IOBFF-01\a7ng_astra_11_a09r3_uart_iobff_wrap.sv"))
$lines += (ShaLine (Join-Path $root "results\A7-NATIVE-GRAPH\ASTRA-11-A09R3-UART-IOBFF-01\clk50_uart_iobff.xdc"))
$lines += (ShaLine (Join-Path $root "results\A7-NATIVE-GRAPH\ASTRA-11-A09R3-UART-IOBFF-HOLD-01\a7ng_astra_11_a09r3_uart_iobff_hold_wrap.sv"))
$lines += (ShaLine (Join-Path $root "results\A7-NATIVE-GRAPH\ASTRA-11-A09R3-UART-IOBFF-HOLD-01\clk50_uart_iobff_hold.xdc"))
$lines += (ShaLine (Join-Path $root "results\A7-NATIVE-GRAPH\ASTRA-09-R3-UART-XSIM-01\a7ng_astra_09_r3_uart_wrap.sv"))
$lines += (ShaLine (Join-Path $root "results\A7-NATIVE-GRAPH\ASTRA-09-R7-UART-QUERY-REW-01\a7ng_astra_09_r7_uart_query_rew_wrap.sv"))
$lines += (ShaLine (Join-Path $root "results\A7-NATIVE-GRAPH\ASTRA-09-R7-UART-QUERY-REW-01\a7ng_astra_09_r7_axi_plant.sv"))
$lines += (ShaLine (Join-Path $root "results\A7-NATIVE-GRAPH\ASTRA-09-R7-UART-QUERY-REW-01\a7ng_astra_09_r7_uart_query_rew.svh"))
...
Write-Host "A11A09R7_SW_IO_SHA_FROZEN $shaPath"
if (-not (Test-Path -LiteralPath $vivado)) { throw "A11A09R7_SW_IO_VIVADO_NOT_FOUND $vivado" }
...
if (Test-Path -LiteralPath $log) {
  $done = [bool](Select-String -Path $log -Pattern "ASTRA_11_A09R7_SW_IO_DONE" -Quiet)
}
if (($exit -ne 0) -or (-not $done)) {
  $r0 = Join-Path $bag "vivado_fail_r0.log"
  if (Test-Path -LiteralPath $log) { Copy-Item $log $r0 -Force }
  throw "A11A09R7_SW_IO_IMPL_FAIL exit=$exit done=$done"
}
...
Write-Host "ASTRA_11_A09R7_SW_IO_RUN_OK"
