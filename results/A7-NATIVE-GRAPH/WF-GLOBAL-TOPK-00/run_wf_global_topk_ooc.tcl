# OOC synth/impl — wf_global_topk_00 VERIFY_ONLY (a7-vivado-gate)
# Targets: (1) a7ng_topk_wavefront_global  (2) a7ng_ddr_wavefront_top if feasible
# No bitstream. Archive under WF-GLOBAL-TOPK-00/.
...
# --- (1) global accumulator leaf ---
set g_rtl {
  rtl/native_graph/pkg/a7ng_pkg.sv
  rtl/native_graph/topk/a7ng_topk.sv
  rtl/native_graph/topk/a7ng_topk_wavefront_global.sv
}
set g_res [wf_ooc_run global a7ng_topk_wavefront_global $g_rtl $clk_xdc]
puts "GLOBAL_ACCUM_RESULT=$g_res"

# --- (2) patched ddr_wavefront top (no MIG; AXI left unconstrained) ---
set wf_rtl {
  rtl/native_graph/pkg/a7ng_pkg.sv
...
puts "A7NG_WF_GLOBAL_TOPK_OOC_DONE"
