#!/usr/bin/env python3
"""Capture COM12 for E2R-HB-CDC-AR-00 — E3 CDC AR probes + D1–D4 heartbeats + optional pred=664."""
...
STAGES = [
    ...
    "CDC_M_ARF", "CDC_S_ARV", "CDC_S_ARR", "CDC_S_ARF", "CDC_HOLD",
...
def main():
    ...
    for k in ("AR_BEAT", "CDC_M_ARF", "CDC_S_ARV", "CDC_S_ARR", "CDC_S_ARF",
              "CDC_HOLD", "MIG_AR", "OWN_WDMA", "CDC_AR", "MUX_CDC"):
