// a7ng_astra_11_a09r7_uart_impl_wrap.sv — ASTRA-11-A09R7-UART-IMPL-ROUTE-01.
// PROGRAM=NO. BIT=NO. Named UART wrap: R7 query-rew FSM + IOB FFs + STA envelope (PREREG).
...
`timescale 1ns / 1ps
`include "a7ng_astra_11_a09r7_uart_impl.svh"

module a7ng_astra_11_a09r7_uart_impl_wrap (
