`ifndef A7NG_ASTRA_11_A09R7_UART_IMPL_SVH
`define A7NG_ASTRA_11_A09R7_UART_IMPL_SVH
// ASTRA-11-A09R7-UART-IMPL-ROUTE-01 protocol (same bytes as R7 XSim wrap).
// PROGRAM=NO. Not PRODUCTION_TOP. Not an edit of ASTRA-09-R7 svh.
