...
// Worlds 0-4 catalog matches F3 strings so extract KEEP stays valid.
...
// Train worlds 0,1,2 only. Hold worlds 3,4 only. Entity disjoint.
localparam int C3_TR_W [0:7] = '{0,1,2,0,1,2,0,1};
localparam int C3_HO_W [0:7] = '{3,4,3,4,3,4,3,4};
localparam bit C3_HO_OV [0:7] = '{0,0,0,0,0,0,0,0};

localparam int C3_W_SUBJ [0:4] = '{10,11,1,6,9};
localparam int C3_W_REL  [0:4] = '{2,2,2,3,2};
// C1 synonym KEEP + ctx keys: k0={subj,ctx[3:0],rel[3:0]} with ctx=2 (indirect).
...
localparam int C3_SH_D0 [0:7] = '{128,132,136,140,144,148,152,156};
localparam int C3_SHH_G0 [0:7] = '{384,388,392,396,400,404,408,412};
localparam int C3_SHH_D0 [0:7] = '{386,390,394,398,402,406,410,414};
