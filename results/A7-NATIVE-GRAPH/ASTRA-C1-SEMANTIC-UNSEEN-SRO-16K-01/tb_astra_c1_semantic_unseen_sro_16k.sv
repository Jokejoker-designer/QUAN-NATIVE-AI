// tb_astra_c1_semantic_unseen_sro_16k.sv — C1 N=16384 unseen/non-grid SRO. PROGRAM=NO.
...
module tb_astra_c1_semantic_unseen_sro_16k;
  import a7ng_pkg::*;
  ...
  initial begin
    ...
    if (fail == 0 && unrelated_empty && (fill_tp > 0) && fill_ids_ok && (unseen_tp > 0) && unbound_empty && unbound_no_leak && (incomp_retrieve == 0) && (G_N == 16384) && (G_PLANTED_N >= 8)) begin
      $display("ASTRA_C1_SEMANTIC_UNSEEN_SRO_16K_XSIM_PASS");
      ...
      $display("ASTRA_C1_SEMANTIC_UNSEEN_SRO_16K_XSIM_NO_MARKER fail=%0d unrelated_empty=%0d fill_tp=%0d fill_ids_ok=%0d unseen_tp=%0d unbound_empty=%0d unbound_no_leak=%0d incomp_retrieve=%0d G_N=%0d planted=%0d",
        fail, unrelated_empty, fill_tp, fill_ids_ok, unseen_tp, unbound_empty, unbound_no_leak, incomp_retrieve, G_N, G_PLANTED_N);
      $display("NOT_CLAIMED=C1_800k,BOARD_PASS,ASTRA-13,CAND_CAP_FINAL,DDR_QUERY_BOUND_FINAL,PAGE_SKIP_MIX,N_65536,MASTER_95,ACCEPT_BOARD");
      $display("C1_800K=OPEN BOARD_PASS=NOT_CLAIMED PROGRAM=NO");
      $display("REDUCTION_X1000=NOT_EMITTED");
    end
