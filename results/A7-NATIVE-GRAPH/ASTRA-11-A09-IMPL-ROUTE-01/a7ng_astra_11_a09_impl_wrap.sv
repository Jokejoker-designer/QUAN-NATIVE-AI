// a7ng_astra_11_a09_impl_wrap.sv — ASTRA-11-A09-IMPL-ROUTE-01. PROGRAM=NO. BIT=NO.
// Named impl/route wrapper. Instantiates a7ng_astra_09_integ_path (no copy-paste graph).
// MMCM 100→50 + BUFG so routed WNS includes clock-network delay. No UART. No BRAM plant.
`timescale 1ns / 1ps

module a7ng_astra_11_a09_impl_wrap (
  ...
  logic [15:0] epoch, n_upd, n_dup, n_bad, n_stale, n_oor, n_exh;
  logic [1:0]  sel_idx;
  ...
  logic        m_axi_arvalid, m_axi_rready, axi_ost, axi_abort;
