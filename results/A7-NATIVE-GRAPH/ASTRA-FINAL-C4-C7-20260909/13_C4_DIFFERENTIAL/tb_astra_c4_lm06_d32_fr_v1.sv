`timescale 1ns / 1ps
// G04 D32 FR differential vs frozen IntegerModel. PROGRAM=NO. Not C4_MASTER.
`include "a7ng_astra_c4_lm06_d32_fr_v1.svh"
`include "GOLDEN.svh"

module tb_astra_c4_lm06_d32_fr_v1;
  ...
  initial begin
    ...
    $display("C4_D32_FR_V1 PROGRAM=NO BOARD_PASS=OPEN C4_MASTER=OPEN");
    ...
    if (fail == 0) begin
      ...
      $display("ASTRA_C4_D32_FR_V1_XSIM_PASS n=%0d", A7NG_C4D32_NCASE);
    end else begin
      $display("CLASS_ref_match MISS");
      $display("ASTRA_C4_D32_FR_V1_XSIM_FAIL n=%0d first=%s", fail, first_div);
