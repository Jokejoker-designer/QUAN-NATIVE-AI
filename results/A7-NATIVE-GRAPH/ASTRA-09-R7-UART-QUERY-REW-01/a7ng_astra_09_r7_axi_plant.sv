// a7ng_astra_09_r7_axi_plant.sv — ASTRA-09-R7-UART-QUERY-REW-01. PROGRAM=NO.
// Bag-local labeled AXI plant fixture (as R3). Not silicon BRAM.
// Not an edit of a7ng_axi_bram128 or ASTRA-09-R3 plant source.
`timescale 1ns / 1ps

module a7ng_astra_09_r7_axi_plant (
  input  logic        clk,
  input  logic        rst_n,
