// a7ng_astra_11_a09r3_uart_iobff_hold_plant.sv — ASTRA-11-A09R3-UART-IOBFF-HOLD-01. PROGRAM=NO.
// Bag-local behavioral AXI plant. Not silicon BRAM. Not a7ng_axi_bram128 edit.
// Not PRODUCTION_TOP. Fixture for UART IOB-FF HOLD wrap-route only.
`timescale 1ns / 1ps

module a7ng_astra_11_a09r3_uart_iobff_hold_plant (
  input  logic        clk,
  input  logic        rst_n,
