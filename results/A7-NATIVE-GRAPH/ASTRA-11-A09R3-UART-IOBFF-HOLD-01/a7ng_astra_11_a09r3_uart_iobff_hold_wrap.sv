// a7ng_astra_11_a09r3_uart_iobff_hold_wrap.sv — ASTRA-11-A09R3-UART-IOBFF-HOLD-01.
// PROGRAM=NO. BIT=NO. Named UART wrap with IOB FFs + FALSE_PATH_HOLD_ASYNC_UART (PREREG).
...
module a7ng_astra_11_a09r3_uart_iobff_hold_wrap (
  ...
  (* keep_hierarchy = "yes" *)
  a7ng_astra_11_a09r3_uart_iobff_hold_plant u_plant (
