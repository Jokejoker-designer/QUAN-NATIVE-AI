# ASTRA-C6-WHOLECHIP-COFIT-02. PROGRAM=NO. A09=NO.
...
proc c6_forbid_hw {args} {
  ...
  puts ASTRA_C6_WHOLECHIP_COFIT_02_ABORTED
  exit 1
}
...
# r0: default opt_design ACCESS_VIOLATION in Phase 3 Retarget (Vivado 2026.1).
# Skip retarget; keep const-prop + sweep. Do not edit KEEP. GOLDEN frozen.
if {[catch {opt_design -propconst -sweep} err]} {
  c6_abort OPT $err
  puts ASTRA_C6_WHOLECHIP_COFIT_OPT_MISS
  exit 1
}
puts C6WC_OPT_DONE
