...
# BTN0-BTN3 = D9/C9/B9/B8 (same as FAIL bag). Do not edit ASTRA-11-A09R7-BTN-IO-01.
...
# IDELAYCTRL REFCLK is MMCM 100→200 (CLKOUT1) + BUFG. Not the pipe clock.
#
# BTN pinout FROZEN in PREREG before impl (cited set; no other BTN set in this clone):
#   btn[0]=D9 BTN0 Sch=btn[0]
#   btn[1]=C9 BTN1 Sch=btn[1]
#   btn[2]=B9 BTN2 Sch=btn[2]
#   btn[3]=B8 BTN3 Sch=btn[3]
# BTN input delays FROZEN in PREREG: IN max 2.000 min 0.500 vs clk50u (KEEP; not retuned).
# Those delays bind after synth (btn_iodelay.xdc) when clk50u exists.
# IDELAYE2 tap FROZEN in PREREG: IDELAY_VALUE=31 FIXED REFCLK=200 MHz + IDELAYCTRL.
...
# BTN0-BTN3 (cited constraints/arty_a7_100.xdc) — this bag's unknown
...
# btn[*] is timed (BTN I/O delays vs clk50u). Do not false-path buttons.
...
# Frozen IOB FF policy (PREREG). UART + LED + BTN pad registers.
