# program_e2r_atomic_sdone_probe_00_excl.tcl — JTAG program SDONE ATOM probe bit only
...
set bitfile    [file join $root_dir results A7-NATIVE-GRAPH E2R-ATOMIC-SDONE-PROBE-00 arty_a7_ng_native_v1_atomic_sdone_probe_00.bit]
...
puts "E2R_ATOMIC_SDONE_PROBE_00_EXCL_PROGRAM_PASS file=$bitfile target=$tgt"
exit 0
