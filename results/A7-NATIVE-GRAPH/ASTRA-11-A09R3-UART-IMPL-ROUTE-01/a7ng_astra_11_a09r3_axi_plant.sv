// a7ng_astra_11_a09r3_axi_plant.sv — ASTRA-11-A09R3-UART-IMPL-ROUTE-01. PROGRAM=NO.
// Bag-local behavioral AXI plant. Not silicon BRAM. Not a7ng_axi_bram128 edit.
// Not PRODUCTION_TOP. Fixture for UART wrap-route only.
`timescale 1ns / 1ps

module a7ng_astra_11_a09r3_axi_plant (
  input  logic        clk,
  input  logic        rst_n,
