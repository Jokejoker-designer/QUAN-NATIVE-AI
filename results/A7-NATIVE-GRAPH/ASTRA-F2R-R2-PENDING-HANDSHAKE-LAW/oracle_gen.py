#!/usr/bin/env python3
"""Freeze native-rank-sgd-q8-v1 symmetric law oracles. PROGRAM=NO."""
...
def main() -> None:
    ...
    # floor-shift contrast (not this law): +3,x0=50 -> +4 vs symmetric +5
    ...
    cases["law"] = {
        ...
        "note": "floor-shift F2R bag kept separate; this revision restores Master symmetric law",
    }
