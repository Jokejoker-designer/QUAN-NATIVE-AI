...
16. `16_MASTERPLAN_EXECUTION_PATH.md` — **human-approved gate DAG** to §14 (WF-GLOBAL-TOPK-00 first).
17. `17_MASTERPLAN_BLUEPRINT_V2_IO_AWARE.md` — **Blueprint V2 IO-aware plan** (Phases A–G, iron-law metrics). Package **COMPLETE** 2026-08-23; see `MASTERPLAN_BLUEPRINT_V2_STATUS.md`.
18. `contracts/` — machine-readable interface examples.
19. `templates/` — experiment closeout template.
20. `tools/capacity_estimator.py` — editable resource/throughput estimator.
