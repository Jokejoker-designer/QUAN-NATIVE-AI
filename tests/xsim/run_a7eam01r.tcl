...
set src [list \
    ...
    [file join $xsimdir tb_a7eam01r.sv]]
...
puts $vlog_out
if {[catch {exec xelab tb_a7eam01r -s tb_a7eam01r -timescale 1ns/1ps} elab_out]} {
    puts $elab_out
    puts "XELAB_FAIL"
    exit 3
}
puts $elab_out
if {[catch {exec xsim tb_a7eam01r -runall} sim_out]} {
    puts $sim_out
    puts "XSIM_FAIL"
    exit 4
}
puts $sim_out
if {![string match "*A7EAM01R_XSIM_PASS*" $sim_out]} {
    puts "A7EAM01R_XSIM_NO_PASS"
    exit 5
}
puts "A7EAM01R_XSIM_OK"
