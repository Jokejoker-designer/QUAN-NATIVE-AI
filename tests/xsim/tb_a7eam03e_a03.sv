...
module tb_a7eam03e_a03;
    ...
    initial begin
        ...
        if (d_ab0 !== 16'd739 || d_ac0 !== 16'd581) begin
            $display("TB_FAIL A03 golden init AB=%0d AC=%0d", d_ab0, d_ac0);
            $finish;
        end
        ...
        if (d_ab1 !== 16'd164 || d_ac1 !== 16'd1957) begin
            $display("TB_FAIL A03 golden train AB=%0d AC=%0d", d_ab1, d_ac1);
            $finish;
        end
        ...
        if (d_abR !== 16'd742) begin
            $display("TB_FAIL A03 golden reset AB=%0d", d_abR);
            $finish;
        end
        ...
        if (d_ac2 !== 16'd137 || d_ab1 !== 16'd1370) begin
            $display("TB_FAIL A03 golden swap AC=%0d AB=%0d", d_ac2, d_ab1);
            $finish;
        end
