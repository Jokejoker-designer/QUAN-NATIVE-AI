// a7ng_index_bank.sv — MEM-02 DDR index flush/reload (law: a7ng-mem02-v0). Frozen 01R bit untouched.
`timescale 1ns / 1ps

module a7ng_index_bank #(
  ...
  always_ff @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      unique case (st)
        IDLE: ;
        FAW: begin
          m_axi_awaddr <= NG_DDR_INDEX_BASE + {12'd0, idx, 4'b0000};
          m_axi_awvalid <= 1;
        ...
        RAR: begin
          m_axi_araddr <= NG_DDR_INDEX_BASE + {12'd0, idx, 4'b0000};
          m_axi_arvalid <= 1;
