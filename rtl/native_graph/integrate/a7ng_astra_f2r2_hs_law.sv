// a7ng_astra_f2r2_hs_law.sv — ASTRA-F2R-R2-PENDING-HANDSHAKE-LAW. PROGRAM=NO.
// New candidate. Does not edit F2R-01 RTL or frozen bags.
`timescale 1ns / 1ps

module a7ng_astra_f2r2_hs_law #(
  ...
  input  logic [1:0]  ctrl_i,  // 0 update, 1 freeze
  ...
  typedef enum logic [3:0] {
    S_IDLE, S_WALK, S_AR, S_R, S_EI, S_EJ, S_SC, S_SW, S_PICK, S_HOLD, S_UW
  } st_t;
  st_t st;
  ...
  logic pend_acc, pend_cmt, retire_hold, freeze_q;
        ...
        S_HOLD: begin
          ...
          if (rew_v_i) begin
            if (!pend_acc) nbad <= nbad + 16'd1;
              ...
              // freeze: refuse update, leave accepted uncommitted
