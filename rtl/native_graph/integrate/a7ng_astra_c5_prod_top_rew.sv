// a7ng_astra_c5_prod_top_rew.sv — ASTRA-C5-EXPLICIT-REWARD-01A. PROGRAM=NO.
// Named copy of prod_top. Does not edit live a7ng_astra_c5_prod_top.sv.
// Removes auto +3 on ANSWER. Reward is a host UART frame (ver/session/txn/gen/
// scalar/CRC/len). Does not wire live C3 txn/gen as the reward identity.
// Does not close 01B (full 32-weight DDR restore). Does not stamp C5_MASTER.
`timescale 1ns / 1ps
...
module a7ng_astra_c5_axi1b_rew (
  input  logic        clk,
  input  logic        rst_n,
...
module a7ng_astra_c5_prod_top_rew (
  input  logic        clk,
  input  logic        rst_n,
