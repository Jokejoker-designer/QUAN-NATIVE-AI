`ifndef A7NG_ASTRA_C5_PROD_TOP_STREAM_SVH
`define A7NG_ASTRA_C5_PROD_TOP_STREAM_SVH
// ASTRA-C5-UART-STREAM-04A. PROGRAM=NO.
// Named C5 top. Final defaults are MIG ui_clk estimate + 115200.
// Do not put 8000/800 here. Sim override is TB #(.CLK_HZ,.BAUD) only.
// Does not freeze DDR_QUERY_BOUND_FINAL. Does not edit live prod_top.svh.
