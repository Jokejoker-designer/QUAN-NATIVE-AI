// a7ng_gate14_c9_soa_lm_xsim.sv — P2-GATE14-C9-SOA-LM-BIT-04
// Learned-prior graph (one store, one scorer, one minheap) + existing bind + TinyGPT.
// No persist FAST-ID C9. PROGRAM=NO. Fast/no-MIG.
`timescale 1ns / 1ps

module a7ng_gate14_c9_soa_lm_xsim (
  input  logic         clk,
  input  logic         rst_n,
