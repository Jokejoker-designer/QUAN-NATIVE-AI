// a7ng_astra_09_integ_path.sv — ASTRA-09-INTEGRATED-PATH-01. PROGRAM=NO.
// New named integrator. Does not edit F2R-* / F3-* / ASTRA-06-* bags or frozen RTL.
...
// Semantic CONFLICT/wrong-object refuse; AXI SLVERR/timeout drain. load_from_tb=0.
`timescale 1ns / 1ps
`include "a7ng_astra_09_integ_path.svh"

module a7ng_astra_09_integ_path #(
