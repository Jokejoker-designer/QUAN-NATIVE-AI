// a7ng_query_axi_sparse_stream_intersect.sv — ASTRA-C1-STREAM-INTERSECT-02
...
// New walker: postings sorted by nid, 1-beat page buffer (4 IDs),
// rare-list-first fetch, two-pointer AND, CAND_CAP after emit only.
// Budget exhaust → q_incomplete_o (SEARCH_INCOMPLETE), never empty-as-UNKNOWN.
// Do NOT union k0 with k1. Do NOT probe k2/k3. Do NOT load full posting BRAM.
// Do NOT patch C0 dir/extract/sparse. poke_v held 0 by TB. PROGRAM=NO.
`timescale 1ns / 1ps

module a7ng_query_axi_sparse_stream_intersect #(
