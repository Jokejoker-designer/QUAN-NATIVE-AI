// a7ng_astra_f2r3_sem_guard.sv — ASTRA-F2R-R3-SEMANTIC-GUARD-01. PROGRAM=NO.
// New candidate. Does not edit F2R-01 / F2R-R2 RTL or frozen bags.
// Instantiates frozen a7ng_shared_rank_sgd_q8_sym_f2r2 (integer law unchanged).
`timescale 1ns / 1ps

module a7ng_astra_f2r3_sem_guard #(
  ...
  typedef enum logic [3:0] {
    S_IDLE, S_WALK, S_AR, S_R, S_EI, S_EJ, S_ED, S_GUARD, S_SC, S_SW, S_PICK, S_HOLD, S_UW
  } st_t;
  st_t st;
