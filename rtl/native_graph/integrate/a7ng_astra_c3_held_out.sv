// a7ng_astra_c3_held_out.sv — ASTRA-C3-HELD-OUT-01. PROGRAM=NO.
// New named wrap. Does not edit C0/C1/C2 KEEP, F3R4, or SGD KEEP files.
// Instantiates C1 synonym KEEP + frozen a7ng_shared_rank_sgd_q8_sym_f2r2.
// freeze_i follows ctrl_i (arm B). Compact TB-AXI. Not BOARD. Not Master self-close.
// Polarity CONFLICT: positive 2-hop dest D and negative 2-hop dest D → ST_CONFLICT.
// Two positive dests still rank (held-out). Does not edit C0/C1/C2 KEEP.
`timescale 1ns / 1ps
`include "a7ng_astra_c3_held_out.svh"

module a7ng_astra_c3_held_out #(
  parameter int unsigned ID_W       = 20,
  parameter int unsigned CAND_CAP   = 16,
  parameter int unsigned TO_CYC     = A7NG_C3_TO_CYC,
  parameter int unsigned MAX_PATH   = A7NG_C3_MAX_PATH,
