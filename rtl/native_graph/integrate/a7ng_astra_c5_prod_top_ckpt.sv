// a7ng_astra_c5_prod_top_ckpt.sv — ASTRA-C5-EXPLICIT-REWARD-01B. PROGRAM=NO.
// Named copy of prod_top_rew. Does not edit live a7ng_astra_c5_prod_top.sv
// and does not instantiate C2 KEEP on 0x06000000. Snapshot/restore is the
// SGD32 bank used by C3. Does not stamp C5_MASTER. Pending-state restore OPEN.
`timescale 1ns / 1ps
...
module a7ng_astra_c5_axi1b_ckpt (
  input  logic        clk,
  input  logic        rst_n,
...
module a7ng_astra_c5_prod_top_ckpt (
  input  logic        clk,
  input  logic        rst_n,
  ...
  a7ng_astra_c5_axi1b_ckpt u_adp (
    .clk(clk), .rst_n(rst_n),
