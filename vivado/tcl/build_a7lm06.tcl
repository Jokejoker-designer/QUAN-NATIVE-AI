# A7-LM-06: 803k 4-layer tiled-W. Writes arty_a7_lm06.bit ONLY.
# Does not overwrite frozen 00-05 bits.
set script_dir [file normalize [file dirname [info script]]]
set root_dir [file normalize [file join $script_dir ../..]]
set build_dir [file join $root_dir build vivado_a7lm06]
...
create_project -force a7lm06 $build_dir -part $part_name
...
puts "=== SYNTHESIS A7-LM-06 ==="
synth_design -top arty_a7_lm06_top -part $part_name -flatten_hierarchy rebuilt -directive PerformanceOptimized
...
write_checkpoint -force [file join $out_dir a7lm06_post_synth.dcp]
report_utilization -file [file join $out_dir a7lm06_utilization_synth.rpt]

puts "=== IMPLEMENT A7-LM-06 ==="
