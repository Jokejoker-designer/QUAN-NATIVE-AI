# A7-LM-04 candidate r2: CDC busy-fall start + same 100k core.
# Writes arty_a7_lm04r.bit ONLY. Does not overwrite FAIL candidate arty_a7_lm04.bit.
set script_dir [file normalize [file dirname [info script]]]
set root_dir [file normalize [file join $script_dir ../..]]
set build_dir [file join $root_dir build vivado_a7lm04r]
...
if {![file exists $fail_bit]} {
    puts stderr "ERROR: refuse to build r2 without FAIL candidate bit present"
    exit 3
}

set part_name xc7a100tcsg324-1
create_project -force a7lm04r $build_dir -part $part_name
...
write_checkpoint -force [file join $out_dir a7lm04r_post_synth.dcp]
report_utilization -file [file join $out_dir a7lm04r_utilization_synth.rpt]

puts "=== IMPLEMENT A7-LM-04R ==="
...
foreach frozen {arty_a7_lm00.bit arty_a7_lm01.bit arty_a7_lm02.bit arty_a7_lm03.bit} {
    ...
    if {![file exists $fp]} {
        puts stderr "ERROR: refuse to write LM-04R without frozen $frozen"
        exit 5
    }
