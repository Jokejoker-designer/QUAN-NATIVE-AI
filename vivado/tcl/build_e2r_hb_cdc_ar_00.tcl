# E2R-HB-CDC-AR-00 - E3 CDC-AR sticky probes + D1-D4 retained
...
set outdir [file join $root results A7-NATIVE-GRAPH E2R-HB-CDC-AR-00]
set build_dir [file join $root build e2r_hb_cdc_ar_00]
file mkdir $outdir
...
create_project e2r_hb_cdc_ar_00 $build_dir -part xc7a100tcsg324-1 -force
...
puts "=== IMPLEMENT E2R-HB-CDC-AR-00 ==="
...
if {$gate_pass} {
  puts $cf "# E2R-HB-CDC-AR-00 CLOSEOUT PASS"
  puts $cf ""
  ...
  puts $cf "# E2R-HB-CDC-AR-00 CLOSEOUT FAIL"
  puts $cf ""
...
file mkdir $bitdir
set out_bit [file join $bitdir arty_a7_ng_native_v1_hb_cdc_ar_00.bit]
if {$gate_pass} {
  puts "=== WRITE_BITSTREAM E2R-HB-CDC-AR-00 ==="
  write_bitstream -force $out_bit
  file copy -force $out_bit [file join $outdir arty_a7_ng_native_v1_hb_cdc_ar_00.bit]
