# E2R-LA-PMOD-00 — observe-only Pmod JA (no FSM / law change)
set root [file normalize [file join [file dirname [info script]] ../..]]
set_param general.maxThreads 8
puts "VIVADO maxThreads=[get_param general.maxThreads]"
set outdir [file join $root results A7-NATIVE-GRAPH E2R-LA-PMOD-00]
set build_dir [file join $root build e2r_la_pmod_00]
file mkdir $outdir
...
create_project e2r_la_pmod_00 $build_dir -part xc7a100tcsg324-1 -force
...
add_files -fileset constrs_1 -norecurse [list \
  ...
  [file join $root constraints e2r_la_pmod_ja.xdc] \
  $mig_xdc]
...
file mkdir $bitdir
set out_bit [file join $bitdir arty_a7_ng_native_v1_la_pmod_00.bit]
if {$gate_pass} {
  puts "=== WRITE_BITSTREAM E2R-LA-PMOD-00 ==="
  write_bitstream -force $out_bit
  file copy -force $out_bit [file join $outdir arty_a7_ng_native_v1_la_pmod_00.bit]
