# A7-EAM-00G: board bitstream. Never write arty_a7_lm*.bit.
set script_dir [file normalize [file dirname [info script]]]
set root_dir   [file normalize [file join $script_dir ../..]]
set build_dir  [file join $root_dir build vivado_a7eam00g]
...
set bitfile [file join $out_dir arty_a7_eam00g.bit]
if {[string match *arty_a7_lm* [file tail $bitfile]]} {
    puts stderr "REFUSE: EAM bit path must not be an LM name"
    exit 2
}

create_project -force a7eam00g $build_dir -part $part_name
...
puts "=== SYNTH A7-EAM-00G ==="
synth_design -top arty_a7_eam00b_top -part $part_name -flatten_hierarchy rebuilt
set_property CFGBVS VCCO [current_design]
set_property CONFIG_VOLTAGE 3.3 [current_design]
write_checkpoint -force [file join $out_dir a7eam00g_post_synth.dcp]
report_utilization -file [file join $out_dir a7eam00g_utilization_synth.rpt]
...
write_checkpoint -force [file join $out_dir a7eam00g_post_route.dcp]
report_timing_summary -delay_type min_max -max_paths 10 -file [file join $out_dir a7eam00g_timing_route.rpt]
report_utilization -file [file join $out_dir a7eam00g_utilization_route.rpt]
report_drc -file [file join $out_dir a7eam00g_drc.rpt]
...
set wns 0.0
set tns 0.0
set trpt [file join $out_dir a7eam00g_timing_route.rpt]
set fh [open $trpt r]
set txt [read $fh]
close $fh
...
set man [file join $res_dir build_manifest_00g.json]
set jf [open $man w]
puts $jf [format \
{{"bit":"build/out/arty_a7_eam00g.bit","sha256":"%s","wns_ns":%s,"tns_ns":%s,"cfgbvs":"%s","config_voltage":"%s","ramb36":%d,"ramb18":%d}} \
