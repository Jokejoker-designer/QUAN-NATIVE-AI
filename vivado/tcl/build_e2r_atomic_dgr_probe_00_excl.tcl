# E2R-ATOMIC-DGR-PROBE-00-EXCL — same-cycle dest=4∧owner ATOM pack (one writer)
# Copy of B-FIX excl file list; outdir/build_dir/project name only.
# Do NOT write B-FIX / B2 / F1w / F1v / Grok R6 / frozen LM-06 01R 02M A0.3.
# Do NOT source resume TCLs.
set root [file normalize [file join [file dirname [info script]] ../..]]
set_param general.maxThreads 8
puts "VIVADO maxThreads=[get_param general.maxThreads]"
set outdir [file join $root results A7-NATIVE-GRAPH E2R-ATOMIC-DGR-PROBE-00]
set build_dir [file join $root build e2r_atomic_dgr_probe_excl]
file mkdir $outdir
file mkdir $build_dir
if {[string match "*E2R-WDMA-BFIX-00*" $outdir] ||
  ...
  puts stderr "REFUSE: foreign/B-FIX/B2/F1w/F1v/R6 path outdir=$outdir build_dir=$build_dir"
  exit 3
}
...
create_project e2r_atomic_dgr_probe_00_excl $build_dir -part xc7a100tcsg324-1
...
puts "=== SYNTH E2R-ATOMIC-DGR-PROBE-00-EXCL ==="
...
puts "=== IMPLEMENT E2R-ATOMIC-DGR-PROBE-00-EXCL ==="
...
set out_bit [file join $outdir arty_a7_ng_native_v1_atomic_dgr_probe_00.bit]
...
if {$gate_pass} {
  puts "=== WRITE_BITSTREAM E2R-ATOMIC-DGR-PROBE-00-EXCL ==="
