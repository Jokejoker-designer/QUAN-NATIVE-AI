# A7-LM-02R: ping-pong revision. Does not overwrite frozen 00/01/02 bits.
set script_dir [file normalize [file dirname [info script]]]
set root_dir [file normalize [file join $script_dir ../..]]
set build_dir [file join $root_dir build vivado_a7lm02r]
...
create_project -force a7lm02r $build_dir -part $part_name
...
write_checkpoint -force [file join $out_dir a7lm02r_post_synth.dcp]
report_utilization -file [file join $out_dir a7lm02r_utilization_synth.rpt]

puts "=== IMPLEMENT A7-LM-02R ==="
opt_design
place_design
phys_opt_design
route_design
phys_opt_design
write_checkpoint -force [file join $out_dir a7lm02r_post_route.dcp]
report_timing_summary -delay_type min_max -max_paths 10 -file [file join $out_dir a7lm02r_timing_route.rpt]
report_utilization -file [file join $out_dir a7lm02r_utilization_route.rpt]
...
foreach frozen {arty_a7_lm00.bit arty_a7_lm01.bit arty_a7_lm02.bit} {
    if {![file exists [file join $out_dir $frozen]]} {
        puts stderr "ERROR: refuse to write LM-02R without frozen $frozen"
        exit 5
    }
}
write_bitstream -force [file join $out_dir arty_a7_lm02r.bit]
puts "A7_LM02R_BUILD_PASS bitstream=[file join $out_dir arty_a7_lm02r.bit] WNS=$wns"
