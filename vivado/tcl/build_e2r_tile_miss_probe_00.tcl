# E2R-TILE-MISS-PROBE-00 - F1o: dbg_tile_miss/dst sticky probe after CORE_BUSY
# BOOT..CDC_S_ARR + CDC_S_ARV/HOLD + SOA_Q..PRED + TILE_MISS/TILE_DST
set root [file normalize [file join [file dirname [info script]] ../..]]
set_param general.maxThreads 8
puts "VIVADO maxThreads=[get_param general.maxThreads]"
set outdir [file join $root results A7-NATIVE-GRAPH E2R-TILE-MISS-PROBE-00]
set build_dir [file join $root build e2r_tile_miss_probe_00_f1o]
file mkdir $outdir
...
create_project e2r_tile_miss_probe_00 $build_dir -part xc7a100tcsg324-1 -force
...
puts "=== SYNTH E2R-TILE-MISS-PROBE-00 ==="
...
puts "=== IMPLEMENT E2R-TILE-MISS-PROBE-00 ==="
...
file mkdir $bitdir
set out_bit [file join $bitdir arty_a7_ng_native_v1_tile_miss_probe_00.bit]
if {$gate_pass} {
  puts "=== WRITE_BITSTREAM E2R-TILE-MISS-PROBE-00 ==="
  write_bitstream -force $out_bit
  file copy -force $out_bit [file join $outdir arty_a7_ng_native_v1_tile_miss_probe_00.bit]
