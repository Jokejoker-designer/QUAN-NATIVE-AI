# E2R-B1-RPATH-00  B1 r_path_idle WDMA ownership interlock (D2) + D1 heartbeats retained
...
set outdir [file join $root results A7-NATIVE-GRAPH E2R-B1-RPATH-00]
set build_dir [file join $root build e2r_b1_rpath_00]
file mkdir $outdir
...
create_project e2r_b1_rpath_00 $build_dir -part xc7a100tcsg324-1 -force
...
puts "=== IMPLEMENT E2R-B1-RPATH-00 ==="
...
if {$gate_pass} {
  puts $cf "# E2R-B1-RPATH-00 CLOSEOUT PASS"
  puts $cf ""
  ...
  puts $cf "# E2R-B1-RPATH-00 CLOSEOUT FAIL"
  puts $cf ""
...
file mkdir $bitdir
set out_bit [file join $bitdir arty_a7_ng_native_v1_b1_rpath_00.bit]
if {$gate_pass} {
  puts "=== WRITE_BITSTREAM E2R-B1-RPATH-00 ==="
  write_bitstream -force $out_bit
  file copy -force $out_bit [file join $outdir arty_a7_ng_native_v1_b1_rpath_00.bit]
