# E2R-UART-MGO-HB-FIX-00 - F1w: UART HB 7'd64 MGO fix (no BOOT flood)
...
set build_dir [file join $root build e2r_uart_mgo_hb_fix_00_f1w]
file mkdir $outdir
...
create_project e2r_uart_mgo_hb_fix_00 $build_dir -part xc7a100tcsg324-1 -force
...
puts "=== SYNTH E2R-UART-MGO-HB-FIX-00 ==="
...
puts "=== IMPLEMENT E2R-UART-MGO-HB-FIX-00 ==="
