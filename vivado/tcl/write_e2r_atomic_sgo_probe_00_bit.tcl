# write_e2r_atomic_sgo_probe_00_bit.tcl — bitstream only from routed DCP
# Do NOT place/route again. Do NOT write F1x / B-FIX / R6 / frozen LM-06.
...
open_checkpoint $dcp
# F1x exclusive file list also omitted e2r_la_pmod_ja.xdc. Do not read it
# here: post-route read_xdc unroutes ja and trips RTSTAT. Waive ja-only
# NSTD-1/UCIO-1 (not LiteScope; no ILA).
