# Digilent AXI MIG board stall sweep (mig_board). Never overwrite frozen LM/EAM bits.
# Official mig.prj via XCI — do not hand-edit.
set script_dir [file normalize [file dirname [info script]]]
set root_dir   [file normalize [file join $script_dir ../../..]]
set build_dir  [file join $root_dir build vivado_a7ng_mig_board]
set out_dir    [file join $root_dir build out]
set arch_dir   [file join $root_dir results A7-NATIVE-GRAPH MIG-BOARD]
...
set bitfile [file join $out_dir arty_a7_ng_mig_board.bit]
foreach forbidden {arty_a7_lm arty_a7_eam01r arty_a7_eam02m arty_a7_eam03e} {
    if {[string match *$forbidden* [file tail $bitfile]]} {
        puts stderr "REFUSE: mig_board bit path collides with frozen artifact"
        exit 2
    }
}

create_project -force a7ng_mig_board $build_dir -part $part_name
...
write_checkpoint -force [file join $arch_dir mig_board_post_synth.dcp]

puts "=== IMPLEMENT A7-NG-MIG-BOARD ==="
...
report_timing_summary -delay_type min_max -max_paths 10 -file [file join $arch_dir mig_board_timing.rpt]
report_utilization -file [file join $arch_dir mig_board_utilization.rpt]
write_checkpoint -force [file join $arch_dir mig_board_post_route.dcp]

set wns [get_property SLACK [get_timing_paths -max_paths 1 -nworst 1 -setup]]
puts "MIG_BOARD_WNS=$wns"
if {$wns < 0} {
...
file copy -force $bitfile [file join $arch_dir arty_a7_ng_mig_board.bit]
puts "MIG_BOARD_BIT=$bitfile"
puts "A7NG_MIG_BOARD_IMPL_DONE"
