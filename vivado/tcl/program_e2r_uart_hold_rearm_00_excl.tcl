# program_e2r_uart_hold_rearm_00_excl.tcl — exclusive JTAG program of SDONE ATOM probe bit
# For later gate E2R-UART-HOLD-REARM-00 only. Archived this PREP gate.
# PROGRAM not executed this gate (E2R-UART-HOLD-REARM-PREP-00).
...
puts "E2R_UART_HOLD_REARM_00_EXCL_PROGRAM_PASS REARM file=$bitfile target=$tgt PROGRAM not executed this gate"
exit 0
