# E2R-T2-SPI-WMEM-00 — integrated SoC @ core_clk 12.5 MHz + AXI read CDC to ui_clk
# T2-SPI + F2 decimal UART � full bit if gates PASS
set root [file normalize [file join [file dirname [info script]] ../..]]
set outdir [file join $root results A7-NATIVE-GRAPH E2R-T2-SPI-WMEM-00]
set build_dir [file join $root build e2r_t2_spi_wmem_00]
file mkdir $outdir
...
create_project e2r_t2_spi_wmem_00 $build_dir -part xc7a100tcsg324-1 -force
...
puts "=== IMPLEMENT E2R-T2-SPI-WMEM-00 ==="
...
if {$gate_pass} {
  puts $cf "# E2R-T2-SPI-WMEM-00 CLOSEOUT — PASS"
  puts $cf ""
  ...
  puts $cf "# E2R-T2-SPI-WMEM-00 CLOSEOUT — FAIL"
  puts $cf ""
...
file mkdir $bitdir
set out_bit [file join $bitdir arty_a7_ng_native_v1_t2_spi_wmem_00.bit]
if {$gate_pass} {
  puts "=== WRITE_BITSTREAM E2R-T2-SPI-WMEM-00 ==="
  write_bitstream -force $out_bit
  file copy -force $out_bit [file join $outdir arty_a7_ng_native_v1_t2_spi_wmem_00.bit]
