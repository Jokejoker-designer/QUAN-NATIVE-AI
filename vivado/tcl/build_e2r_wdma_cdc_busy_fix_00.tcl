# E2R-WDMA-CDC-BUSY-FIX-00 - F1s: m_busy deassert after m_done until next m_go
set root [file normalize [file join [file dirname [info script]] ../..]]
set_param general.maxThreads 8
puts "VIVADO maxThreads=[get_param general.maxThreads]"
set outdir [file join $root results A7-NATIVE-GRAPH E2R-WDMA-CDC-BUSY-FIX-00]
set build_dir [file join $root build e2r_wdma_cdc_busy_fix_00_f1s]
file mkdir $outdir
...
create_project e2r_wdma_cdc_busy_fix_00 $build_dir -part xc7a100tcsg324-1 -force
...
puts "=== SYNTH E2R-WDMA-CDC-BUSY-FIX-00 ==="
...
puts "=== IMPLEMENT E2R-WDMA-CDC-BUSY-FIX-00 ==="
...
file mkdir $bitdir
set out_bit [file join $bitdir arty_a7_ng_native_v1_wdma_cdc_busy_fix_00.bit]
if {$gate_pass} {
  puts "=== WRITE_BITSTREAM E2R-WDMA-CDC-BUSY-FIX-00 ==="
  write_bitstream -force $out_bit
  file copy -force $out_bit [file join $outdir arty_a7_ng_native_v1_wdma_cdc_busy_fix_00.bit]
