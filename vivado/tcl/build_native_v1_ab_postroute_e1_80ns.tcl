...
# E1-AB-COFIT-PARALLEL-00-CLOCK80 falsifier: 80ns period (~12.5 MHz).
# Stops after route. No write_bitstream.
set root [file normalize [file join [file dirname [info script]] ../..]]
set outdir [file join $root results A7-NATIVE-GRAPH E1-AB-COFIT-PARALLEL-00-CLOCK80]
file mkdir $outdir
set build_dir [file join $root build native_v1_board_parallel_e1_80ns]
...
create_clock -name clk -period 80.000 [get_ports clk]
...
puts $mf "clock_period_ns=80.000 ramb36=$n36 ramb18=$n18 eq36=$eq36 luts=$luts lutram=$lutram ffs=$ffs dsps=$dsps WNS=$wns TNS=$tns WHS=$whs THS=$ths route_ok=$route_ok"
close $mf
puts "AB_POSTROUTE clock_period_ns=80.000 ramb36=$n36 ramb18=$n18 eq36=$eq36 luts=$luts lutram=$lutram ffs=$ffs dsps=$dsps WNS=$wns TNS=$tns WHS=$whs THS=$ths route_ok=$route_ok"
# no write_bitstream
close_project
