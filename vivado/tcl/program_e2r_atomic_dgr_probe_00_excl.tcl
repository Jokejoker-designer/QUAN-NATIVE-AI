# program_e2r_atomic_dgr_probe_00_excl.tcl — JTAG program ATOM probe bit only
# JTAG must be 210319BE776EA. Refuse second target / PYNQ.
# Do NOT write B-FIX / B2 / F1w / F1v / Grok R6 / frozen LM-06.
set script_dir [file normalize [file dirname [info script]]]
set root_dir   [file normalize [file join $script_dir ../..]]
set bitfile    [file join $root_dir results A7-NATIVE-GRAPH E2R-ATOMIC-DGR-PROBE-00 arty_a7_ng_native_v1_atomic_dgr_probe_00.bit]
...
if {[string match "*E2R-WDMA-BFIX-00*" $bitfile] ||
  ...
  puts stderr "REFUSE: foreign/frozen bit path $bitfile"
  exit 3
}
...
puts "E2R_ATOMIC_DGR_PROBE_00_EXCL_PROGRAM_PASS file=$bitfile target=$tgt"
exit 0
