# E2R-WDMA-BFIX-00-EXCL — cmd-path ghost-busy release (one writer)
# Do NOT write B2 / F1w / F1v dirs. Do NOT source resume TCLs.
# Clone of B2 file list; outdir/build_dir/project name only.
set root [file normalize [file join [file dirname [info script]] ../..]]
set_param general.maxThreads 8
puts "VIVADO maxThreads=[get_param general.maxThreads]"
set outdir [file join $root results A7-NATIVE-GRAPH E2R-WDMA-BFIX-00-EXCL]
set build_dir [file join $root build e2r_wdma_bfix_excl]
file mkdir $outdir
file mkdir $build_dir
if {[string match "*E2R-WDMA-SBUSY-CMD-PROBE-00*" $outdir] ||
  ...
  puts stderr "REFUSE: concurrent B2/F1w/F1v path outdir=$outdir build_dir=$build_dir"
  exit 3
}
...
create_project e2r_wdma_bfix_00_excl $build_dir -part xc7a100tcsg324-1
...
puts "=== SYNTH E2R-WDMA-BFIX-00-EXCL ==="
...
puts "=== IMPLEMENT E2R-WDMA-BFIX-00-EXCL ==="
...
set out_bit [file join $outdir arty_a7_ng_native_v1_wdma_bfix_00_excl.bit]
if {$gate_pass} {
  puts "=== WRITE_BITSTREAM E2R-WDMA-BFIX-00-EXCL ==="
