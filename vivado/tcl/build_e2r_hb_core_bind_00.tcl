# E2R-HB-CORE-BIND-00  T2-SPI SoC + A+ finer post-CORE_START heartbeats
# BOOT..CORE_START + OWNER_RDY/Q_GO/SOA_Q/TOPK/ACCEPT/PACK/BIND/FWD/LM/PRED
set root [file normalize [file join [file dirname [info script]] ../..]]
set outdir [file join $root results A7-NATIVE-GRAPH E2R-HB-CORE-BIND-00]
set build_dir [file join $root build e2r_hb_core_bind_00]
file mkdir $outdir
...
create_project e2r_hb_core_bind_00 $build_dir -part xc7a100tcsg324-1 -force
...
puts "=== SYNTH E2R-HB-CORE-BIND-00 ==="
...
puts "=== IMPLEMENT E2R-HB-CORE-BIND-00 ==="
...
if {$gate_pass} {
  puts $cf "# E2R-HB-CORE-BIND-00 CLOSEOUT PASS"
  puts $cf ""
  ...
  puts $cf "# E2R-HB-CORE-BIND-00 CLOSEOUT FAIL"
  puts $cf ""
...
file mkdir $bitdir
set out_bit [file join $bitdir arty_a7_ng_native_v1_hb_core_bind_00.bit]
if {$gate_pass} {
  puts "=== WRITE_BITSTREAM E2R-HB-CORE-BIND-00 ==="
  write_bitstream -force $out_bit
  file copy -force $out_bit [file join $outdir arty_a7_ng_native_v1_hb_core_bind_00.bit]
