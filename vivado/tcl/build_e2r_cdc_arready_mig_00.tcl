# E2R-CDC-ARREADY-MIG-00 - F1d: wire cdc_arready to real MIG arready
...
set outdir [file join $root results A7-NATIVE-GRAPH E2R-CDC-ARREADY-MIG-00]
set build_dir [file join $root build e2r_cdc_arready_mig_00]
file mkdir $outdir
...
create_project e2r_cdc_arready_mig_00 $build_dir -part xc7a100tcsg324-1 -force
...
puts "=== SYNTH E2R-CDC-ARREADY-MIG-00 ==="
...
puts "=== IMPLEMENT E2R-CDC-ARREADY-MIG-00 ==="
...
file mkdir $bitdir
set out_bit [file join $bitdir arty_a7_ng_native_v1_cdc_arready_mig_00.bit]
if {$gate_pass} {
  puts "=== WRITE_BITSTREAM E2R-CDC-ARREADY-MIG-00 ==="
  write_bitstream -force $out_bit
  file copy -force $out_bit [file join $outdir arty_a7_ng_native_v1_cdc_arready_mig_00.bit]
