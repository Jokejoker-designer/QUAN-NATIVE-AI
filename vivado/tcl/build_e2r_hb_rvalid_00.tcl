# E2R-HB-RVALID-00 - D3 AXI-R sticky markers + D1/D2 retained
# BOOT..R_IDLE + RV_SEEN/RREADY1/RID_OK/RID_BAD/OUTST/MIG_RV/CDC_NE + SOA_Q..PRED
set root [file normalize [file join [file dirname [info script]] ../..]]
set_param general.maxThreads 8
puts "VIVADO maxThreads=[get_param general.maxThreads]"
set outdir [file join $root results A7-NATIVE-GRAPH E2R-HB-RVALID-00]
set build_dir [file join $root build e2r_hb_rvalid_00]
file mkdir $outdir
...
create_project e2r_hb_rvalid_00 $build_dir -part xc7a100tcsg324-1 -force
...
puts "=== IMPLEMENT E2R-HB-RVALID-00 ==="
...
if {$gate_pass} {
  puts $cf "# E2R-HB-RVALID-00 CLOSEOUT PASS"
  puts $cf ""
  ...
  puts $cf "# E2R-HB-RVALID-00 CLOSEOUT FAIL"
  puts $cf ""
...
file mkdir $bitdir
set out_bit [file join $bitdir arty_a7_ng_native_v1_hb_rvalid_00.bit]
if {$gate_pass} {
  puts "=== WRITE_BITSTREAM E2R-HB-RVALID-00 ==="
  write_bitstream -force $out_bit
  file copy -force $out_bit [file join $outdir arty_a7_ng_native_v1_hb_rvalid_00.bit]
