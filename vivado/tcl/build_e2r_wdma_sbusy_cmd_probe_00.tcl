# E2R-WDMA-SBUSY-CMD-PROBE-00 — F1B2 exclusive: UART stickies only (one writer)
# Do NOT write to E2R-UART-MGO-HB-FIX-00-EXCL/ or build/e2r_uart_mgo_hb_fix_00_f1w_excl/
set root [file normalize [file join [file dirname [info script]] ../..]]
set_param general.maxThreads 8
puts "VIVADO maxThreads=[get_param general.maxThreads]"
set outdir [file join $root results A7-NATIVE-GRAPH E2R-WDMA-SBUSY-CMD-PROBE-00]
set build_dir [file join $root build e2r_wdma_sbusy_cmd_probe_00]
file mkdir $outdir
...
create_project e2r_wdma_sbusy_cmd_probe_00 $build_dir -part xc7a100tcsg324-1
...
puts "=== SYNTH E2R-WDMA-SBUSY-CMD-PROBE-00 ==="
...
puts "=== IMPLEMENT E2R-WDMA-SBUSY-CMD-PROBE-00 ==="
...
set out_bit [file join $outdir arty_a7_ng_native_v1_wdma_sbusy_cmd_probe_00.bit]
if {$gate_pass} {
  puts "=== WRITE_BITSTREAM E2R-WDMA-SBUSY-CMD-PROBE-00 ==="
