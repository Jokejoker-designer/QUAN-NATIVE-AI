# E2R-UART-MGO-HB-FIX-00-EXCL - F1w exclusive: UART HB 7'd64 MGO (one writer)
# Do NOT write to E2R-UART-MGO-HB-FIX-00/ or build/e2r_uart_mgo_hb_fix_00_f1w/
set root [file normalize [file join [file dirname [info script]] ../..]]
set_param general.maxThreads 8
puts "VIVADO maxThreads=[get_param general.maxThreads]"
set outdir [file join $root results A7-NATIVE-GRAPH E2R-UART-MGO-HB-FIX-00-EXCL]
set build_dir [file join $root build e2r_uart_mgo_hb_fix_00_f1w_excl]
file mkdir $outdir
...
create_project e2r_uart_mgo_hb_fix_00_excl $build_dir -part xc7a100tcsg324-1
...
puts "=== SYNTH E2R-UART-MGO-HB-FIX-00-EXCL ==="
...
puts "=== IMPLEMENT E2R-UART-MGO-HB-FIX-00-EXCL ==="
...
set out_bit [file join $outdir arty_a7_ng_native_v1_uart_mgo_hb_fix_00_excl.bit]
if {$gate_pass} {
  puts "=== WRITE_BITSTREAM E2R-UART-MGO-HB-FIX-00-EXCL ==="
