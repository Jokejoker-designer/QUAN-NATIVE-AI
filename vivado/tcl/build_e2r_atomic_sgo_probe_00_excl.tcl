# E2R-ATOMIC-SGO-PROBE-00-EXCL — dest=4∧owner SGO ATOM pack (one writer)
# Copy of F1x/B-FIX excl file list; outdir/build_dir/project name only.
# Do NOT write F1x / DGR / B-FIX / B2 / F1w / F1v / Grok R6 / frozen LM-06 01R 02M A0.3.
# Do NOT source resume TCLs. Do NOT reprogram F1x SHA 77116381...
set root [file normalize [file join [file dirname [info script]] ../..]]
set_param general.maxThreads 8
puts "VIVADO maxThreads=[get_param general.maxThreads]"
set outdir [file join $root results A7-NATIVE-GRAPH E2R-ATOMIC-SGO-PROBE-00]
set build_dir [file join $root build e2r_atomic_sgo_probe_excl]
file mkdir $outdir
...
if {[string match "*E2R-ATOMIC-DGR-PROBE-00*" $outdir] ||
  ...
  puts stderr "REFUSE: foreign/F1x/B-FIX/B2/F1w/F1v/R6 path outdir=$outdir build_dir=$build_dir"
  exit 3
}
...
create_project e2r_atomic_sgo_probe_00_excl $build_dir -part xc7a100tcsg324-1
...
puts "=== SYNTH E2R-ATOMIC-SGO-PROBE-00-EXCL ==="
...
puts "=== IMPLEMENT E2R-ATOMIC-SGO-PROBE-00-EXCL ==="
...
set out_bit [file join $outdir arty_a7_ng_native_v1_atomic_sgo_probe_00.bit]
...
if {$gate_pass} {
  puts "=== WRITE_BITSTREAM E2R-ATOMIC-SGO-PROBE-00-EXCL ==="
