# E2R-HB-UART-00  T2-SPI SoC + staged UART heartbeats (Option A Gate4 localize)
# T2-SPI + F2 decimal UART + BOOT/MIG/WMEM/SOA/CORE/BIND/LM heartbeats
set root [file normalize [file join [file dirname [info script]] ../..]]
set outdir [file join $root results A7-NATIVE-GRAPH E2R-HB-UART-00]
set build_dir [file join $root build e2r_hb_uart_00]
file mkdir $outdir
...
create_project e2r_hb_uart_00 $build_dir -part xc7a100tcsg324-1 -force
...
if {$gate_pass} {
  puts $cf "# E2R-HB-UART-00 CLOSEOUT PASS"
  puts $cf ""
  ...
  puts $cf "# E2R-HB-UART-00 CLOSEOUT FAIL"
  puts $cf ""
...
file mkdir $bitdir
set out_bit [file join $bitdir arty_a7_ng_native_v1_hb_uart_00.bit]
if {$gate_pass} {
  puts "=== WRITE_BITSTREAM E2R-HB-UART-00 ==="
  write_bitstream -force $out_bit
  file copy -force $out_bit [file join $outdir arty_a7_ng_native_v1_hb_uart_00.bit]
