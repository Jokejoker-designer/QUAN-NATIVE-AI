# E2R-CLOCK-CDC-00 — integrated SoC @ core_clk 12.5 MHz + AXI read CDC to ui_clk
# NO bitstream (acceptance = timing + CDC + BRAM only)
set root [file normalize [file join [file dirname [info script]] ../..]]
set outdir [file join $root results A7-NATIVE-GRAPH E2R-CLOCK-CDC-00]
set build_dir [file join $root build e2r_clock_cdc_00]
file mkdir $outdir
...
create_project e2r_clock_cdc_00 $build_dir -part xc7a100tcsg324-1 -force
...
puts "=== IMPLEMENT E2R-CLOCK-CDC-00 ==="
...
if {$gate_pass} {
  puts $cf "# E2R-CLOCK-CDC-00 CLOSEOUT — PASS"
  puts $cf ""
  ...
  puts $cf "# E2R-CLOCK-CDC-00 CLOSEOUT — FAIL"
  puts $cf ""
