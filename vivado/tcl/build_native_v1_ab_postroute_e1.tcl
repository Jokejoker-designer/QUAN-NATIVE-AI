...
# E1-AB-COFIT-PARALLEL-00 board lane co-fit gate. Stops after route. No write_bitstream.
set root [file normalize [file join [file dirname [info script]] ../..]]
set outdir [file join $root results A7-NATIVE-GRAPH E1-AB-COFIT-PARALLEL-00]
file mkdir $outdir
set build_dir [file join $root build native_v1_board_parallel_e1]
...
puts $mf "ramb36=$n36 ramb18=$n18 eq36=$eq36 luts=$luts lutram=$lutram ffs=$ffs dsps=$dsps WNS=$wns WHS=$whs route_ok=$route_ok"
close $mf
puts "AB_POSTROUTE ramb36=$n36 ramb18=$n18 eq36=$eq36 luts=$luts lutram=$lutram ffs=$ffs dsps=$dsps WNS=$wns WHS=$whs route_ok=$route_ok"
# no write_bitstream
close_project
